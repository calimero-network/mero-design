...
# manifest appVersion both derive from $APP_VERSION (they must not drift; the old
...
FALLBACK_VERSION="2.2.4"   # offline floor only; the registry path is authoritative
