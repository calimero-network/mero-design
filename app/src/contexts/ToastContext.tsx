...
// Mirrors curb's ToastContext/ToastManager but kept dependency-free with inline
// styles so it can sit at the app root without extra CSS plumbing.
...
const base: CSSProperties = {
  ...
  cursor: "pointer",
  animation: "md-toast-in 0.18s ease",
};
